...
![](./img/mascot/welcome.png){ width="140px" align="left"}
...
```bibtex
@book{mccreary2026ecology,
  title     = {Ecology: Systems Thinking for a Changing Planet -- An Interactive Intelligent Textbook with Simulations},
  author    = {McCreary, Dan},
  year      = {2026},
  url       = {https://dmccreary.github.io/ecology/},
