...
Please generate a wide-landscape 16:9 cover image for a graphic novel titled "The Forest Web" in a Pacific Northwest forest art style reminiscent of a luminous forests meets scientific illustration.
The style is a luminous forest rendered with soft, diffused light filtering through a dense canopy, creating shifting patterns of dappled gold and green across leaves, moss, and forest floor. Light behaves organically, with gentle beams illuminating suspended particles in the air and giving foliage a subtle inner glow. The scene is rich with layered depth: detailed foreground elements like ferns, bark textures, and fallen branches transition into misty midground trunks and softly faded background silhouettes. Moisture is ever-present—dew on leaves, damp soil, and a humid atmosphere that enhances the sense of life and vitality.

The environment blends ecological realism with a quiet sense of wonder, where every element feels interconnected and alive. Colors are natural yet slightly heightened—deep forest greens, warm amber highlights, and cool shadow tones in blue and violet. Fine botanical details ground the scene, while faint, almost imperceptible glows and gentle movements suggest hidden networks and subtle life beneath the surface. The overall tone is calm, immersive, and reverent, evoking both scientific observation and a sense of awe at the unseen relationships within the forest.

Show Suzanne Simard, a sturdy, practical woman in her 40s with brown hair pulled back, wearing a plaid flannel shirt, field vest, and hiking boots, standing at the base of an enormous old-growth Douglas fir in a British Columbia forest. One hand rests on the bark of the tree. The scene is split: above ground, towering conifers with dappled golden-green light filtering through the canopy, sword ferns, and mossy logs; below ground, a luminous cross-section reveals a vast mycorrhizal network rendered as softly glowing golden-white threads connecting the root systems of trees of all sizes. The largest tree's roots glow brightest, acting as the hub. The title text "The Wood Wide Web" is rendered in organic, root-like typography at the top. Color palette: deep forest green, Douglas fir brown, dappled gold, moss emerald, rich soil umber above ground; warm bioluminescent gold, amber, and soft violet for the underground fungal network. Emotional tone: wonder, interconnection, and the hidden life beneath our feet. Include: 

(1) Simard's bright, determined eyes and practical field clothing, 
(2) towering old-growth Douglas firs with textured bark, 
(3) the cross-section revealing the underground root and fungal network, 
(4) glowing mycorrhizal threads connecting large and small trees, 
(5) a young seedling above ground visibly connected to the mother tree's root network below, 
(6) Pacific Northwest forest floor details — sword ferns, mossy nurse logs, shelf fungi on a snag.
