---
title: World Biome Map
description: Classify and locate the seven major terrestrial biomes on an interactive world map with hover details.
image: /sims/biome-world-map/biome-world-map.png
og:image: /sims/biome-world-map/biome-world-map.png
twitter:image: /sims/biome-world-map/biome-world-map.png
social:
   cards: false
quality_score: 80
---
...
1. [Biome - Wikipedia](https://en.wikipedia.org/wiki/Biome) - Overview of terrestrial biome classification and characteristics
2. [World Wildlife Fund: Biomes](https://www.worldwildlife.org/biomes) - Detailed descriptions of global biome types and their conservation status
3. [p5.js Reference](https://p5js.org/reference/) - JavaScript library used for the interactive map visualization
