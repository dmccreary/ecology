...
description: Detect cognitive biases and logical fallacies in environmental arguments through gamified practice.
image: /sims/bias-detective/bias-detective.png
og:image: /sims/bias-detective/bias-detective.png
twitter:image: /sims/bias-detective/bias-detective.png
social:
   cards: false
quality_score: 82
---
...
<iframe src="main.html" height="680" width="100%" scrolling="no"></iframe>

[Run the Cognitive Bias Detective MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
...
```html
<iframe src="https://dmccreary.github.io/ecology/sims/bias-detective/main.html"
        height="587px"
        width="100%"
        scrolling="no"></iframe>
```
...
1. [List of Cognitive Biases - Wikipedia](https://en.wikipedia.org/wiki/List_of_cognitive_biases) - Comprehensive catalog of known cognitive biases and their effects on reasoning
2. [Logical Fallacies - Wikipedia](https://en.wikipedia.org/wiki/List_of_fallacies) - Reference for common logical fallacies in argumentation
