---
title: Ecosystem Components Interactive Explorer
description: Interactive p5.js drag-and-sort activity where students classify 16 ecosystem components as biotic or abiotic factors and explore their interactions.
image: /sims/ecosystem-components-explorer/ecosystem-components-explorer.png
og:image: /sims/ecosystem-components-explorer/ecosystem-components-explorer.png
twitter:image: /sims/ecosystem-components-explorer/ecosystem-components-explorer.png
social:
   cards: false
quality_score: 81
---
...
[Run the Ecosystem Components Interactive Explorer MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
...
```html
<iframe src="https://dmccreary.github.io/ecology/sims/ecosystem-components-explorer/main.html"
        height="547px"
        width="100%"
        scrolling="no"></iframe>
```
...
3. National Geographic Society. "Ecosystem." [https://education.nationalgeographic.org/resource/ecosystem](https://education.nationalgeographic.org/resource/ecosystem)
