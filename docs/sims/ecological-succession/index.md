...
description: Interactive p5.js MicroSim for ecological succession timeline.
image: /sims/ecological-succession/ecological-succession.png
og:image: /sims/ecological-succession/ecological-succession.png
twitter:image: /sims/ecological-succession/ecological-succession.png
social:
   cards: false
quality_score: 0
---
...
<iframe src="main.html" height="930" width="100%" scrolling="no"></iframe>

[Run the Ecological Succession Timeline MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
[Edit in the p5.js Editor](https://editor.p5js.org/dmccreary/sketches/2MrziMIZ_)
...
```html
<iframe src="https://dmccreary.github.io/biology/sims/ecological-succession/main.html"
        height="830px"
        width="100%"
        scrolling="no"></iframe>
```
