...
description: Interactive p5.js decision-tree workflow guiding students through the SIFT method to evaluate environmental claims using source investigation, coverage finding, and original tracing.
image: /sims/fact-check-workflow/fact-check-workflow.png
og:image: /sims/fact-check-workflow/fact-check-workflow.png
twitter:image: /sims/fact-check-workflow/fact-check-workflow.png
social:
   cards: false
quality_score: 85
---
