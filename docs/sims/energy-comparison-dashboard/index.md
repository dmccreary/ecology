---
title: Energy Source Comparison Dashboard
description: Interactive Chart.js radar chart comparing 8 energy sources across multiple dimensions including EROI, emissions, land use, reliability, cost, and scalability.
image: /sims/energy-comparison-dashboard/energy-comparison-dashboard.png
og:image: /sims/energy-comparison-dashboard/energy-comparison-dashboard.png
twitter:image: /sims/energy-comparison-dashboard/energy-comparison-dashboard.png
social:
   cards: false
quality_score: 80
---
...
[Run the Energy Source Comparison Dashboard MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
...
```html
<iframe src="https://dmccreary.github.io/ecology/sims/energy-comparison-dashboard/main.html"
        height="707px"
        width="100%"
        scrolling="no"></iframe>
```
