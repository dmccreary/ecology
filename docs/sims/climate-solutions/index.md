---
title: Climate Solutions Pathway
description: Interactive simulation where students activate and combine climate solutions across energy, transport, land use, industry, and policy to see projected temperature outcomes.
image: /sims/climate-solutions/climate-solutions.png
og:image: /sims/climate-solutions/climate-solutions.png
twitter:image: /sims/climate-solutions/climate-solutions.png
social:
   cards: false
quality_score: 80
---
...
[Run the Climate Solutions Pathway MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
...
```html
<iframe src="https://dmccreary.github.io/ecology/sims/climate-solutions/main.html"
        height="502px"
        width="100%"
        scrolling="no"></iframe>
```
...
3. Project Drawdown. (2024). Climate Solutions. [drawdown.org](https://drawdown.org/solutions)
