...
description: Interactive p5.js step-through animation tracing nitrogen through fixation, nitrification, assimilation, decomposition, and denitrification with labeled organisms at each stage.
image: /sims/nitrogen-cycle/nitrogen-cycle.png
og:image: /sims/nitrogen-cycle/nitrogen-cycle.png
twitter:image: /sims/nitrogen-cycle/nitrogen-cycle.png
social:
   cards: false
quality_score: 83
---
...
[Run the Nitrogen Cycle MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
...
```html
<iframe src="https://dmccreary.github.io/ecology/sims/nitrogen-cycle/main.html"
        height="547px"
        width="100%"
        scrolling="no"></iframe>
```
