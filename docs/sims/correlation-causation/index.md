---
title: Correlation vs. Causation Challenge
description: Interactive quiz-style MicroSim where students classify relationships between correlated environmental variables as causal, reverse causal, confounded, or truly causal.
...
[Run the Correlation vs. Causation Challenge MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
...
```html
<iframe src="https://dmccreary.github.io/ecology/sims/correlation-causation/main.html"
        height="482px"
        width="100%"
        scrolling="no"></iframe>
```
...
3. EPA. "Environmental Data and Research." [https://www.epa.gov/data](https://www.epa.gov/data)
