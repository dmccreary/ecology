...
description: Interactive p5.js MicroSim for monoculture vs. polyculture ecosystem comparison.
...
[Run the Monoculture vs. Polyculture Ecosystem Comparison MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
