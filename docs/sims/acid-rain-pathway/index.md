---
title: Acid Rain Formation and Impact Pathway
description: Trace SO2 and NOx emissions through atmospheric chemistry to acid deposition and ecological damage.
image: /sims/acid-rain-pathway/acid-rain-pathway.png
og:image: /sims/acid-rain-pathway/acid-rain-pathway.png
twitter:image: /sims/acid-rain-pathway/acid-rain-pathway.png
social:
   cards: false
quality_score: 80
---
...
[Run the Acid Rain Formation and Impact Pathway MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
...
1. [Acid Rain - Wikipedia](https://en.wikipedia.org/wiki/Acid_rain) - Comprehensive overview of acid rain chemistry, history, and ecological effects
2. [EPA: Effects of Acid Rain](https://www.epa.gov/acidrain/effects-acid-rain) - U.S. Environmental Protection Agency resource on acid rain impacts
3. [vis.js Network Documentation](https://visjs.github.io/vis-network/docs/network/) - JavaScript library used for the interactive network diagram
