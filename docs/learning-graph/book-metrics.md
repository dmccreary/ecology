...
| 2 | Chapters | 17 | Required | Chapter directories with index.md |
| 3 | MicroSims | 83 | Recommended | Interactive simulations in docs/sims/ |
| 4 | Stories | 17 | Optional | Graphic-novel narratives in docs/stories/ |
| 5 | Chapter Quizzes | 17 / 17 | Recommended | Chapters with a quiz.md (170 questions total) |
| 6 | Chapter References | 17 / 17 | Recommended | Chapters with references.md (170 references total) |
| 7 | Glossary Terms | 381 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 102 | Recommended | Questions in faq.md |
| 9 | Words | 338,840 | Required | Words across student-facing markdown |
...
|-------------|-------------|---------------|-------|
| Diagrams | 82 | 82 | H4 headers starting with '#### Diagram:' |
| Equations | 2 | 1 | LaTeX expressions (inline and display) |
| Total Words | 338,840 | 111,049 | Words in markdown files |
| Links | 782 | 189 | Hyperlinks in markdown format |
| Equivalent Pages | 1417 | 506 | Estimated pages (250 words/page + visuals) |
