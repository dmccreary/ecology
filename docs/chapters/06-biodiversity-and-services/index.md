---
title: "Chapter 6: Biodiversity and Ecosystem Services"
description: "Explore biodiversity at species and ecosystem levels, essential ecosystem services, island biogeography, ecological tolerance, and how ecosystems recover through succession."
...
**Instructional Rationale:** A visual pyramid helps students see that biodiversity operates at nested scales -- genetic diversity within species diversity within ecosystem diversity.
...
**Instructional Rationale:** Interactive manipulation of island parameters lets students discover the species-area relationship and distance effect through experimentation rather than memorization.
...
**Instructional Rationale:** Draggable tolerance curves let students physically explore how specialists and generalists respond differently to environmental shifts, building intuition before formal analysis.
...
**Instructional Rationale:** An animated timeline with togglable succession types lets students directly compare the pace and stages of primary vs. secondary succession, reinforcing that the key difference is the presence or absence of soil.
...
Type: graph-model
**sim-id:** ecosystem-services-web<br/>
...
**Instructional Rationale:** A network graph makes abstract connections between service categories tangible and interactive, supporting systems thinking by letting students trace cascading effects.
...
??? question "What's the difference between species richness and species evenness?"
...
??? question "Why are larger islands generally more biodiverse than smaller islands?"
...
??? question "A volcanic eruption covers an island in fresh lava. What type of succession will follow, and why?"
...
??? question "A farmer stops cultivating a field and walks away. Describe what happens over the next 200 years."
...
??? question "Name one ecosystem service from each of the four categories and explain how they're connected."
