---
title: "Chapter 10: Land and Water Use"
description: "How humans use land and water resources, the ecological consequences, and sustainable alternatives including integrated pest management, sustainable agriculture, and urban planning."
...
27. No-Till Farming
28. Aquaculture
29. Sustainable Forestry
30. Urban Runoff Reduction
...
- [Chapter 7: Population Ecology](../07-population-ecology/index.md)
- [Chapter 8: Earth Systems and Resources](../08-earth-systems/index.md)
- [Chapter 9: Sustainability and Energy Resources](../09-sustainability-and-energy/index.md)
...
## Introduction: Sharing a Finite Planet
...
**Instructional Rationale:** Side-by-side simulation lets students observe emergent differences in pest spread, soil health, and yield stability -- making abstract ecological principles concrete.
...
1. **Prevention** -- crop rotation, resistant varieties, habitat management
2. **Monitoring** -- regular scouting to assess pest populations
3. **Thresholds** -- act only when pest levels cause economic damage
4. **Biological control** -- use natural predators and parasites first
5. **Chemical control** -- targeted pesticides only as a last resort, applied precisely
...
**Instructional Rationale:** Interactive decision trees make procedural knowledge concrete and help students understand that IPM is a systematic process, not just "use less pesticide."
...
**Instructional Rationale:** Interactive cross-section visualization connects abstract temperature data to visible landscape features, building spatial reasoning about urban ecology.
...
Type: microsim
**sim-id:** soil-health-comparison<br/>
**Library:** p5.js<br/>
**Status:** Specified
...
**Instructional Rationale:** Time-lapse simulation makes decades-long soil processes visible in seconds, connecting farming decisions to ecological outcomes that are normally invisible.
...
1. **Check the denominator.** "Pesticide use increased 50%!" -- per acre? Per ton of food? Total? Per dollar of revenue? The denominator changes the story completely.
2. **Ask about alternatives.** Every land-use critique implies an alternative. What IS the alternative, and what are its trade-offs?
3. **Look for peer-reviewed sources.** Advocacy organizations on all sides cherry-pick data. Journal articles must survive peer review.
4. **Consider scale.** What works on a 10-acre organic farm may not scale to feeding 8 billion people. What works for industrial agriculture may not work for small communities.
