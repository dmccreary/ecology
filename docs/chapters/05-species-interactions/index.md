---
title: "Chapter 5: Species Interactions"
description: "Explore ecological relationships between organisms, from predation and competition to mutualism and parasitism, and how these interactions shape communities."
...
1. Prey population increases (lots of food, few predators)
2. Predator population increases in response (more prey to eat)
3. Heavy predation drives prey population down
4. Predators starve and their population declines
5. With fewer predators, prey recovers — and the cycle repeats
...
**Instructional Rationale:** Interactive simulation with adjustable parameters lets students test hypotheses about population cycles and observe emergent oscillation patterns.
...
Type: microsim
**sim-id:** resource-partitioning<br/>
**Library:** p5.js<br/>
**Status:** Specified
...
**Instructional Rationale:** Visual overlay of foraging zones on a single tree makes abstract niche concepts concrete and spatial.
...
<iframe src="../../sims/coevolution/main.html" width="100%" height="500px" scrolling="no"></iframe>

<details markdown="1">
<summary>Coevolution Arms Race Simulator</summary>
Type: microsim
**sim-id:** coevolution<br/>
**Library:** p5.js<br/>
**Status:** Specified
...
**Instructional Rationale:** Generation-by-generation simulation makes the abstract concept of coevolution visible and interactive.
...
**Instructional Rationale:** Step-by-step cascade visualization helps students trace indirect effects through a community, building systems-thinking skills.
...
1. **Is a single species really the cause?** Ecosystems are complex. The Yellowstone wolf story is real, but elk behavior was also influenced by human hunting, drought, and other factors. Attributing everything to one species is appealing but incomplete.
2. **What's the time scale?** Some interactions take decades to play out. A one-year study might miss the full picture.
3. **Who funded the study?** Research on invasive species control is sometimes funded by industries that profit from control methods (pesticide companies, hunting organizations). This doesn't invalidate the science, but it's worth knowing.
4. **Are anecdotes being used as evidence?** "I saw fewer songbirds after the cats moved in" is an observation, not proof of causation. Look for population data and controlled studies.
...
!!! mascot-warning "Bailey's Warning!"
