...
description: "A tour of Earth's major terrestrial and aquatic biomes, ecosystem structure, and energy flow through food chains and food webs."
...
**Instructional Rationale:** Spatial visualization helps students connect biome characteristics to geographic location and climate patterns.
...
**Instructional Rationale:** A vertical cross-section visualization helps students grasp the scale of ocean depth and the gradient of conditions (light, temperature, pressure).
...
**Instructional Rationale:** Building a food web from scratch deepens understanding of trophic relationships. The removal simulation demonstrates trophic cascades concretely.
...
1. **Energy pyramids:** Always upright — energy always decreases going up
2. **Biomass pyramids:** Usually upright (but can be inverted in aquatic ecosystems where producers reproduce rapidly)
3. **Numbers pyramids:** Can be inverted (one tree supports thousands of insects)
...
**Instructional Rationale:** Interactive sliders let students manipulate efficiency percentages and see how small changes in transfer efficiency dramatically affect top-predator energy.
...
<iframe src="../../sims/biome-connections/main.html" width="100%" height="500px" scrolling="no"></iframe>

<details markdown="1">
<summary>Biome Connections Network</summary>
Type: microsim
**sim-id:** biome-connections<br/>
**Library:** vis-network<br/>
**Status:** Specified
...
**Instructional Rationale:** A network graph reveals non-obvious connections between biomes, reinforcing systems thinking. Students explore what happens when one biome is disrupted.
...
1. **Find the original source.** This claim has been repeated so often that tracing it to a single study is difficult — that's a yellow flag.
2. **Check with experts.** Atmospheric scientists point out that the Amazon's photosynthesis does produce about 20% of terrestrial oxygen, but its decomposition and respiration consume nearly the same amount. The net contribution to atmospheric oxygen is close to zero.
3. **Look for nuance.** The Amazon is critically important for carbon storage, biodiversity, and regional climate — but the "lungs of the Earth" metaphor is misleading when it comes to oxygen production.
...
??? question "Self-Test: Check Your Understanding"
    ...
    **5.** If producers in an ecosystem capture 50,000 kcal of energy, how much energy is available to tertiary consumers? Show your work.
    ...
    ??? success "Answer"
        ...
        Primary consumers: 5,000 kcal →
        Secondary consumers: 500 kcal →
        Tertiary consumers: **50 kcal**
